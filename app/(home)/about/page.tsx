...
import Breadcrumb from "@/components/home/about/breadcrumb";
        ...
        <div className="flex flex-col gap-8 lg:flex-row pb-24">
          ...
          <div className="flex flex-1 flex-col items-start justify-center">
            ...
            <p className="text-gray-50 ">
              ...
              Laboriosam ipsum provident eos nisi architecto maxime cupiditate
              amet sunt, delectus, voluptate distinctio omnis aperiam veritatis
              saepe nobis temporibus facilis maiores exercitationem!
            </p>
            <br />
            <p className="text-gray-50">
